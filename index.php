...
session_start();// Display errors in the browser (for debugging only, not in production)
...
<div id="page-wrapper">
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            ...
                            Guide you Home</h1>
                            <form method="post" action="/propertygrid">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="city" placeholder="Enter Areas" required>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                            ...
                            <h5 class="text-secondary hover-text-success py-3 m-0"><a href="property.php">Selling Service</a></h5>
                            <p>We help you sell your property at the best market value with professional marketing and verified buyers.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                            <i class="flaticon-for-rent text-success flat-medium" aria-hidden="true"></i>
                            <h5 class="text-secondary hover-text-success py-3 m-0"><a href="property.php">Rental Service</a></h5>
                            <p>Find reliable tenants or discover your ideal rental home with our hassle-free rental management solutions.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                            <i class="flaticon-list text-success flat-medium" aria-hidden="true"></i>
                            <h5 class="text-secondary hover-text-success py-3 m-0"><a href="contact.php">Property Listing</a></h5>
                            <p>Explore verified property listings with detailed insights, high-quality images, and transparent pricing.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                            <i class="flaticon-diagram text-success flat-medium" aria-hidden="true"></i>
                            <h5 class="text-secondary hover-text-success py-3 m-0"><a href="contact.php">Legal Investment</a></h5>
                            <p>Get expert guidance on legal documentation and safe real estate investments with complete compliance support.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <ul>
        <li class="mb-4 text-white d-flex"> 
            ...
            <div class="pl-2">
                <h5 class="mb-3">Top Rated Properties</h5>
                <p>We showcase premium listings that are carefully verified, ensuring you get access to the best homes, offices, and investment opportunities available in the market.</p>
            </div>
        </li>
        <li class="mb-4 text-white d-flex"> 
            <i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
            <div class="pl-2">
                <h5 class="mb-3">Unmatched Quality</h5>
                <p>From modern apartments to luxury villas, every property in our portfolio is selected with a focus on construction quality, location benefits, and long-term value.</p>
            </div>
        </li>
        <li class="mb-4 text-white d-flex"> 
            <i class="flaticon-seller flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
            <div class="pl-2">
                <h5 class="mb-3">Expert Real Estate Agents</h5>
                <p>Our team of certified and experienced agents provides end-to-end support and helping you with property discovery, negotiations, legal guidance, and smooth closing.</p>
            </div>
        </li>
    </ul>
</div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="icon-thumb-one text-center mb-5">
                    ...
                    <p>Connect with our property experts to share your requirements, budget, and preferences for buying, selling, or renting.</p>
                </div>
            </div>
            <!-- Step 2 -->
            <div class="col-md-4">
                <div class="icon-thumb-one text-center mb-5">
                    ...
                    <p>We verify property documents, legal clearances, and ownership details to ensure safe and transparent transactions.</p>
                </div>
            </div>
            <!-- Step 3 -->
            <div class="col-md-4">
                <div class="icon-thumb-one text-center mb-5">
                    ...
                    <p>Finalize your deal with complete assistance on agreements, payments, and property handover  stress-free and secure.</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										$query=mysqli_query($con,"SELECT count(location), property.* FROM property where lower(location)=lower('South city one')");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="locationproperty.php?id=<?php echo $row['location']?>"><?php echo $row['location'];?></a></h4>
                                    <span><?php 
												$total = $row[0];
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/2.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										$query=mysqli_query($con,"SELECT count(location), property.* FROM property where location='Sushant lok'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="locationproperty.php?id=<?php echo $row['location']?>"><?php echo $row['location'];?></a></h4>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/3.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(location), property.* FROM property where location='Greenwood City'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="locationproperty.php?id=<?php echo $row['location']?>"><?php echo $row['location'];?></a></h4>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/4.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(location), property.* FROM property where location='Palm Society'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="locationproperty.php?id=<?php echo $row['location']?>"><?php echo $row['location'];?></a></h4>
