<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
            ...
            <div class="row">
                <div class="col-md-8">
                    <ul class="top-contact list-text-white  d-table">
                        <li><a href="#"><i class="fas fa-phone-alt text-success mr-1"></i>+91 7827601216</a></li>
                        <li><a href="#"><i
                                    class="fas fa-envelope text-success mr-1"></i>Propertygateway007@gmail.com</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
    ...
    <style>
        .text-success {
            color: #ebc483 !important;
        }

        .btn-success {
            background-color: #ebc483 !important;
            border-color: #ebc483 !important;
            ;
            ...
            <div class="row">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative"
                            href="index.php"><img class="nav-logo" height="50" src="images/logo/logo.png" alt=""></a>
